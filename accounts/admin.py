...
class MotardAdmin(UserAdmin):
    model = Motard
    list_display = ("_profile",'matricule', 'nom', 'prenom', 'username', 'email', 'phone', 'is_validated', 'is_staff', 'is_active')
    ...
    fieldsets = (
        ...
        ('Informations personnelles', {
            'fields': ('matricule','nom', 'prenom', 'date_naissance', 'lieu_naissance', 'email', 'phone', 'address', 'photo_identite', 'autre_piece', 'profile')
        }),
